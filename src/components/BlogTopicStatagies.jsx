...
function BlogTopicStatagies() {
  return (
    <div>
      ...
      <div className="flex flex-col md:grid md:grid-cols-2 md:gap-5 lg:gap-7 xl:gap-5 xl:grid-cols-3">
        <NavLink
...
export default BlogTopicStatagies;
